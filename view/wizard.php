<form>
	<table class="slidetoggle describe">
		<tbody>
			<tr>
				<th valign="top" scope="row" class="label"><span class="alignleft">Filename <small>(in /videos/)</small></span></th>
				<td class="field" style="width: 75%"><input type="text" class="text" id="src" name="src" style="width: 100%" /></td>
			</tr>
			<tr>
				<th valign="top" scope="row" class="label"><span class="alignleft">Width <small>(px)</small></span><br class='clear' /></th>
				<td class="field"><input type="text" id="width" name="width" style="width: 100%" /></td>
			</tr>
			<tr>
				<th valign="top" scope="row" class="label"><span class="alignleft">Height <small>(px)</small></span></th>
				<td class="field"><input type="text" id="height" name="height" style="width: 100%" /></td>
			</tr>
			<tr>
				<th valign="top" scope="row" class="label"><span class="alignleft">Splash Image</span></th>
				<td class="field"><input type="text" id="splash" name="splash" style="width: 100%" /></td>
			</tr>
			<tr>
				<th valign="top" scope="row" class="label"><span class="alignleft">HTML Popup</span></th>
